...
| `npm --prefix infra run cdk -- synth --quiet` | after infra changes, or when you want to generate `infra/cdk.out` | Equivalent to `cdk synth` if you have the CDK CLI available. |
